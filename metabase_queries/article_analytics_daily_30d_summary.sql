-- Сводный отчет по артикулам за последние 30 дней.
-- Разрез: day + article + sku
-- Колонки: 18 метрик из /v1/analytics/data
...
WHERE ad.date::date BETWEEN CURRENT_DATE - INTERVAL '29 days' AND CURRENT_DATE
